...
{
    internal static class BarsHelperColorsSetterTitleBarBlackWhite
    {
        internal static void SetTitleBarBlackWhiteColors(ApplicationViewTitleBar titleBar, ElementTheme requestedTheme)
        {
